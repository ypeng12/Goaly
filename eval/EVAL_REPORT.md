...
Generated: `2026-09-14T15:29:20.927203+00:00`. Engine: MockEngine (no live provider calls).

Scenarios: **33/33 passed** across 50 turns.
Mean measured turn execution: 2.073 ms (local state machine plus mock response; excludes HTTP and model latency).
