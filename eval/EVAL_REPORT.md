...
Generated: `2026-09-14T04:33:12.272625+00:00`. Engine: MockEngine (no live provider calls).

Scenarios: **33/33 passed** across 50 turns.
Mean measured turn execution: 1.323 ms (local state machine plus mock response; excludes HTTP and model latency).
